...
export class DashboardComponent implements OnInit {
    ...
    editDialog(entity) {
        console.log(`Inside DashboardComponent.editDialog(${JSON.stringify(entity)})`);
        console.log(entity);
    ...
    allChecked() {
        console.log('DashboardComponent.allChecked()');
    ...
    bulkActionIntersection() {
        console.log('DashboardComponent.bulkActionIntersection()');
    ...
    onCBChange(entity) {
        console.log('DashboardComponent.onCBChange()');
        this.bulkActionIntersection();
        console.log(`Final ${JSON.stringify(this.bulkActionList)}`);
    }

    onBulkAction(action) {
        console.log(`DashboardComponent.applyBulkAction(${action})`);
