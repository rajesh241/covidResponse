export default class RefData {
    ...
    static IT_FEATURES = ['history', 'market', 'opportunity', 'price_drop', 'narc', 'pet', 'last'];
    static IT_FEATURES_NAMES = ['History', 'Market', 'Opportunity', 'Price Drop', 'Controlled Substance', 'PET Meds', 'Last'];
    static IT_FEATURES_IMAGE = {
            history: '<i class="fa fa-history fa-w-16 fa-2x" style="align:center; color:#A5B6FA;"></i>',       // blue
            market: '<i class="fa fa-warning fa-w-16 fa-2x" style="align:center; color:#F4747A;"></i>',        // exclamation red // cyan = #8AD4DF
            opportunity: '<i class="fa fa-usd fa-w-16 fa-2x" style="align:center; color:#C0E48E;"></i>',       // violet
            price_drop: '<i class="fa fa-arrow-down fa-w-16 fa-2x" style="align:center; color:#FBC1D5;"></i>', // green
            narc: '<i class="fa fa-asterisk fa-w-16 fa-2x" style="align:center; color:#FEBE89;"></i>',         // orange
            pet: '<i class="fa fa-bug fa-w-16 fa-2x" style="align:center; color:#8A8A8A;"></i>',               // gray
            last: '<i class="fa fa-calendar fa-w-16 fa-2x" style="align:center; color:#DEA4ED;"></i>',         // pink
        };
